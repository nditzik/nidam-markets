...
ALL_WEEK = (0, 1, 2, 3, 4, 5, 6)   # קריפטו — 24/7
...
MARKETS = [
    ...
    # קריפטו (13.9.2026, איציק): כרטיסים כמו המדדים, מתחת למפת העולם. נסחר 24/7 —
    # תמיד "נסחר" כשהציטוט טרי. השינוי היומי של Yahoo לקריפטו הוא מול 00:00 UTC.
    ("btc",    "ביטקוין",       "₿",  "BTC-USD",    "קריפטו", (0.0, 24.0),  ALL_WEEK),
    ("eth",    "את'ריום",       "Ξ",  "ETH-USD",    "קריפטו", (0.0, 24.0),  ALL_WEEK),
    ("xrp",    "XRP",           "✕",  "XRP-USD",    "קריפטו", (0.0, 24.0),  ALL_WEEK),
]
